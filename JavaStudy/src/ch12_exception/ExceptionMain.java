...
public class ExceptionMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// try 블록 내에서 발생할 수 있는
			// 에러 종류에 대한 클래스
			// 해당 에러가 발생하면 catch 블록 내부 실행됨
			System.out.println("예외 발생!!");
			System.out.println("에러메세지: " + except.getMessage());

			// 에러 로그 출력 (항상 보던거)
			// System.err.println() 으로 출력 됨
...
//			int commend = 0;
//			try {
//				commend = Integer.parseInt(scan.nextLine());
...
//		}
		...
		// SELECT문 1줄 이상 출력
		// WHERE절을 걸었더니 만약 SELECT문 실행결과 0줄이다
